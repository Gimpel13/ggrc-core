...
describe('person-form-field component', function () {
  ...
  it('adds a person and fiers valueChanged event' +
   'if new person is not in the list', function () {
    ...
    const dispatchedObject = viewModel.dispatch.calls.mostRecent().args[0];
  ...
  it('removes a person and fires valueChanged event', function () {
